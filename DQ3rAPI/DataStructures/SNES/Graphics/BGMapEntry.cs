using DQ3rAPI.Attributes;
using System.Globalization;

namespace DQ3rAPI.DataStructures.SNES.Graphics;
	...
	public int Data {
		...
		set {
			if (value is < 0 or > 0xffff) {
				throw new ArgumentOutOfRangeException($"Value must be between 0 and 0xffff: {value}, {value.ToString("x4", CultureInfo.InvariantCulture)}");
			}
