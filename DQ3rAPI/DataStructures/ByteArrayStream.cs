namespace DQ3rAPI.DataStructures;
...
public class ByteArrayStream {
	...
	public byte Byte() => Buffer.Span[Address++];

	public void Byte(byte value) => Buffer.Span[Address++] = value;

	public byte ByteAt(int offset) => Buffer.Span[Address + offset];
