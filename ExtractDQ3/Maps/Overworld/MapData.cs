...
public static class MapData {
	...
	public static byte[] GetLayout() => DQ3Lib.Maps.Overworld.MapData.GetLayout(Rom rom, DefaultValues.MapsOverworldMapDataLayoutAddress);

	// Overworld tilemap top-level grid layout
	public static byte[] GetLayout(Rom rom, PCAddress? address) {
		var source = rom.GetStream(address ?? new PCAddress(0xed8a00));
