...
namespace logsmall {
	class OverworldMap2 {
		...
		public static Ram GetLayout() { //(int A, int X) {
										// I think this is map layout (when to read a block of sea or something or when to read map data)
										// see debug log: trying to find water 02
										// code start: c04923
										// code end: c04a43
			...
			/*
			 ...
			 Each word represents 1 column by 4 rows of tilemap data  --- this might not be right
			 So 256 x 256 is reduced to pointers for 256 x 32
		...
		public static void TestGetLayout() {
			...
			var generated = ram.ByteArray(0x7f0000);
			var i = 0;
			var good = 0;
			var bad = 0;
