...
class Line {
	...
	protected static Regex IsBranchRegex = new(@"^(bcc|bcs|beq|bmi|bne|bpl|bra|bvc|bvs|brl)$", RegexOptions.Compiled);
	...
	protected static Regex IsCallRegex = new(@"^(jsr|jsl)$", RegexOptions.Compiled);
	public bool IsCall {
		get {
	...
	protected static Regex IsJumpRegex = new(@"^(jmp|jml)$", RegexOptions.Compiled);
	public bool IsJump {
		get {
